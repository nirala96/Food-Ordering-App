...
class SignupPage extends StatelessWidget {
  ...
  void addData(){
    var url = Uri.parse("http://192.168.43.185/flutter-login-signup/adddata.php");
    http.post(url,body: {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  FadeAnimation(1.2, makeInput(label: "Email",controller_val: cusername)),
                  FadeAnimation(1.3, makeInput(label: "Password", controller_val: cpassword,obscureText: true)),
